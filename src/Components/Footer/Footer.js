...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-slate-900  text-slate-400">
            <div>
                ...
                <p>
                    <span className='font-bold text-lg'>Code Quiz Game Ltd.</span> <br />Providing Quiz since 1992
                </p>
